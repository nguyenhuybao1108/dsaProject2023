...
public class Board implements Serializable, Cloneable {
    ...
    private Stack moveHistory = new Stack(size);
    Point moveFrom;
    ...
    public void doMove(Move m, boolean playerMove) {
        ...
        moveFrom = m.getPiece().getLocation();
        moveHistory.push(m);
    ...
    public void getPreviousMove(){
        ...
        if(lastMove instanceof CastleMove){
            System.out.println("Undoing a castle move is not yet implemented.");
            // Add code here to handle undoing a castle move
        }
        else{
            Piece movePiece = getPieceAt(lastMove.getMoveTo());
            movePiece.moveTo(lastMove.getPiece().getLocation());
        }
        if(lastMove.getCaptured() != null){
            addPiece(lastMove.getCaptured());
        }

        this.turn = previousBoard.getTurn();
        this.inCheck = previousBoard.getPieceInCheck();
        this.lastMoved = previousBoard.getLastMovedPiece();
        this.pieces = new ArrayList<>(previousBoard.getPieces());
        setPreviousState(previousBoard);
    }
